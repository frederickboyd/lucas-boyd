...
const Resume = () => {
  ...
  const experience = [
    {
      ...
      company: "Law School Admission Council (LSAC)",
    ...
    },
    {
      position: "Software Engineer",
      company: "Toptal",
      duration: "February 2012 – February 2016",
      description:
  ...
  const certifications = [
    {
      ...
      date: "2023",
      skills: "AWS, Serverless, Lambda, Cloud Development",
    ...
    },
    {
      ...
      issuer: "Microsoft",
      date: "2022",
      skills: "Azure, Cloud Apps, DevOps, CI/CD",
    ...
    },
    {
      ...
      issuer: "Pluralsight",
      date: "2021",
      skills: ".NET Core, Microservices, Performance Tuning",
      credential: "PS-NET-2021",
    },
    {
      name: "React.js & TypeScript Masterclass",
      issuer: "Udemy",
      date: "2021",
      skills: "React, TypeScript, Front-end Architecture",
      credential: "UDEMY-RTS-2021",
    },
    {
      name: "Docker & Kubernetes for Developers",
      issuer: "Coursera",
      date: "2020",
      skills: "Docker, Kubernetes, DevOps Pipelines",
      credential: "COURSERA-DK-2020",
    },
  ];
  ...
  const tabContent = {
    ...
    certifications: (
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {certifications.map((c, index) => (
          <motion.div key={c.name} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: index * 0.1 }} className="glass-panel p-6 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground mb-1">{c.issuer} • {c.date}</div>
                <div className="flex flex-wrap gap-2 mb-2">
                  {c.skills.split(",").map((s) => (
                    <span key={s.trim()} className="text-xs bg-secondary rounded-full px-2 py-1">{s.trim()}</span>
                  ))}
                </div>
                <div className="text-xs text-muted-foreground">Credential ID: {c.credential}</div>
              </div>
            </div>
          </motion.div>
        ))}
