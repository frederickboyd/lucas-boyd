        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="text-2xl font-bold text-brand-purple mb-2">Lucas Boyd.</div>
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex space-x-4">
                <motion.a
                  href="https://github.com/lucas-boyd-838"
                  target="_blank"
                ...
                <motion.a
                  href="https://www.linkedin.com/in/lucas-boyd-633049397/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-brand-purple transition-colors bg-secondary p-3 rounded-full"
                  whileHover={{ scale: 1.1 }}
          ...
          <div className="text-muted-foreground text-sm text-center mt-8">
            © {new Date().getFullYear()} Lucas Boyd. All rights reserved.
          </div>
        </div>
      </footer>
      <ScrollToTop />
