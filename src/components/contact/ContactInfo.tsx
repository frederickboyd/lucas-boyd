  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "boydlucas838@gmail.com",
      link: "boydlucas838@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Ethel Louisiana 70730",
      link: "https://maps.google.com/?q=Ethel+Louisiana+70730",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/lucas-boyd-838",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/lucas-boyd-633049397",
    }
  ];
