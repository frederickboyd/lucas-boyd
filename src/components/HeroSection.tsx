      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Experienced software engineer with over 15 years in designing, developing, and deploying scalable web applications across EdTech, FinTech, and SaaS industries.
